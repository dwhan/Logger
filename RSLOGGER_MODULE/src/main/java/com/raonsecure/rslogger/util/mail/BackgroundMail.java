package com.raonsecure.rslogger.util.mail;
...
import com.raonsecure.rslogger.R;
...
public class BackgroundMail {
    ...
    public void send() {
        ...
        if (!Utils.isNetworkAvailable(mContext)) {
            RSLoggerManager.getInstance().d(Configuration.getInstance().getApplicationName(), "you need internet connection to send the email");
        }
